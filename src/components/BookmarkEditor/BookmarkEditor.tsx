      ...
      <div className="mini-card">
        <div className="mini-card-head">
          <span className="mini-card-title">
            <Link2 size={11} style={{ color: 'var(--accent-color)' }} />
