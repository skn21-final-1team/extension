...
const TREE_HEIGHT_NORMAL = 'var(--tree-max-height)'
...
function Sidebar({ isSettingsOpen, onCloseSettings }: SidebarProps) {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* 북마크 트리 — --sidebar-tree-height 변수로 높이 제어 */}
      <div
        className="sidebar-tree"
        style={{ '--sidebar-tree-height': treeHeight } as React.CSSProperties}
      >
        {bookmarks.length === 0 ? (
